    ...
    <c:choose>
        ...
        <div id="inner">
            ...
            <div id="botNav">
                <ul>
                    <li>
                        <div id="jjsf" onMouseOver="flash()"><a href="${ctx}/courseWord/one?id=${courseWord.id}&wordType=fb"><img src="${ctxStatic}/image/jjsf1.png" class="btnToggle" width="136" height="51" /></a></div>
                    </li>
                    <c:choose>
                        <c:when test="${not empty courseWord.qbVideoUrl}">
                            <li>
                                <div id="djyqx" onMouseOver="flash()"><a href="${ctx}/courseWord/one?id=${courseWord.id}&wordType=qb"><img src="${ctxStatic}/image/qbsx1.png" class="btnToggle" width="136" height="51" /></a></div>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li>
                                <div id="djyqx" onMouseOver="flash()"><a href="${ctx}/courseWord/one?id=${courseWord.id}&wordType=gb"><img src="${ctxStatic}/image/djyqx1.png" class="btnToggle" width="136" height="51" /></a></div>
                            </li>
                        </c:otherwise>
                    </c:choose>
                    <li>
                        <div id="sfxs" onMouseOver="flash()"><a href="${ctx}/courseWord/one?id=${courseWord.id}&wordType=mb"><img src="${ctxStatic}/image/sfxs1.png" class="btnToggle" width="136" height="51" /></a></div>
                    </li>
                </ul>
            </div>
            <div id="backrd">
