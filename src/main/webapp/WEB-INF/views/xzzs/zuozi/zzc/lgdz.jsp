...
<div id="content" class="zzc-lgdz">
    ...
    <div id="bhBtn" style="position:absolute;bottom:26px;right:122px">
        <a href="${ctx}/xzzs/zuozi/zzc/index"><img src="${ctxStatic}/shufaketang/images/button/return1.png" class="btnToggle" width="85" height="57" /></a>
    </div>
</div>
</body>
</html>
