...
<body>
<div id="content" class="wbzd-${code}">
    ...
    <div id="bhBtn" style="position:absolute;bottom:20px;right:125px">
        <a href="${ctx}/xzzs/wobi/wbzd/index"><img src="${ctxStatic}/shufaketang/images/button/return1.png" class="btnToggle" width="85" height="57" /></a>
    </div>
</div>
</body>
</html>
