...
<head>
    ...
    <style type="text/css">
        #main { background: url(${ctxStatic}/shufaketang/images/2_1_1.jpg) no-repeat 0 0; }
...
<div id="main">
    <div class="wrap">
        ...
        <div class="gMenu clearfix" style="top:125px;">
            <ul>
                <c:forEach items="${ylist}" var="item" begin="0" end="11">
            ...
            <ul>
                <c:forEach items="${ylist}" var="item" begin="12">
                    <li style="height: 28px;line-height: 28px;">
                        <a href="${ctx}/sfkt/lession/list?calligraphyId=${item.code}">第${item.number}讲：${item.title}</a>
                    </li>
                </c:forEach>
